...
def edge_loading(arr):
    return np.abs(arr)[:4] * np.array(
        [
            ...
            + (arr[(7, 9),] != 0).all()
            + (arr[(5, 9),] != 0).all()
            + ((arr[(4, 8),] != 0).all() or (arr[(4, 7, 9),] != 0).all()),
        ]
    )
...
def positive_edge_loading(arr):
    return (arr[:4] == 1) * np.array(
        [
            ...
            + (arr[(7, 9),] == 1).all()
            + (arr[(5, 9),] == 1).all()
            + ((arr[(4, 8),] == 1).all() or (arr[(4, 7, 9),] == 1).all()),
        ]
    )
...
def factor_loading(arr):
    return np.abs(arr)[:4] * np.array(
        [
            ...
            1
            + (arr[(7),] != 0).sum()
            + ((arr[(4, 7),] != 0).all() or (arr[(5),] != 0).all()),
            1
            + (arr[(9),] != 0).sum()
            + ((arr[(7, 9),] != 0).all() or (arr[(8),] != 0).all())
            + (
                (arr[(4, 7, 9),] != 0).all()
                or (arr[(4, 8),] != 0).all()
                or (arr[(5, 9),] != 0).all()
...
def positive_factor_loading(arr):
    return (arr[:4] == 1) * np.array(
        [
            ...
            1
            + (arr[(7),] == 1).sum()
            + ((arr[(4, 7),] == 1).all() or (arr[(5),] == 1).all()),
            1
            + (arr[(9),] == 1).sum()
            + ((arr[(7, 9),] == 1).all() or (arr[(8),] == 1).all())
            + (
                (arr[(4, 7, 9),] == 1).all()
                or (arr[(4, 8),] == 1).all()
                or (arr[(5, 9),] == 1).all()
