...
class Sim1Plus(AbstractSimulator):
    def __init__(
        self,
        random_state: int = 0,
        ...
        super().__init__(
            n_factor=9, random_state=random_state, cmap=sim1, name=r"Model $\Phi^+$"
        )
    ...
    def plot(self, ax: plt.Axes):
        ...
        ax.annotate("", [5.5, 3.5], [7, 6], arrowprops=ap(5), **arrconf)
        ax.annotate("", [5.6, 3], [7, 3], arrowprops=ap(6), **arrconf)
